 ...
 * @stack: Pointer to a pointer pointing to the top node of the stack.
 * @lineNo: Integer representing the line number of the opcode.
 */
void printString(stack_t **stack, __attribute__((unused)) unsigned int lineNo)
{
	stack_t *temp;
	int ascii;
 ...
 * @lineNo: Integer representing the line number of the opcode.
 */
void rotateLeft(stack_t **stack, __attribute__((unused)) unsigned int lineNo)
{
	stack_t *temp;
 ...
 * @lineNo: Integer representing the line number of the opcode.
 */
void rotateRight(stack_t **stack, __attribute__((unused)) unsigned int lineNo)
{
	stack_t *temp;
